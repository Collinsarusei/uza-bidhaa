...
console.log(`VERCEL_BUILD_DEBUG_FIREBASE_ADMIN: FIREBASE_PROJECT_ID is ${projectId_debug ? 'SET' : 'NOT SET'}`);
console.log(`VERCEL_BUILD_DEBUG_FIREBASE_ADMIN: FIREBASE_CLIENT_EMAIL is ${clientEmail_debug ? 'SET' : 'NOT SET'}`);
...
if (app) {
    ...
    console.error('VERCEL_BUILD_ERROR_FIREBASE_ADMIN: Firebase app instance is null after init attempt.');
    throw new Error('Firebase App instance null (Vercel build)');
}
